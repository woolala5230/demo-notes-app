...
exports.Migrator = exports.NO_MIGRATIONS = exports.MIGRATION_LOCK_ID = exports.MIGRATION_LOCK_TABLE = exports.MIGRATION_TABLE = void 0;
const object_utils_js_1 = require("../util/object-utils.js");
const private_symbols_js_1 = require("../util/private-symbols.js");
exports.MIGRATION_TABLE = 'kysely_migration';
exports.MIGRATION_LOCK_TABLE = 'kysely_migration_lock';
...
class Migrator {
     ...
     */
    async getMigrations() {
        const executedMigrations = (await this.#doesTableExists(exports.MIGRATION_TABLE))
            ? await this.#props.db
                .selectFrom(exports.MIGRATION_TABLE)
    ...
    async #ensureMigrationTableExists() {
        if (!(await this.#doesTableExists(exports.MIGRATION_TABLE))) {
            try {
                await this.#props.db.schema
                    .createTable(exports.MIGRATION_TABLE)
                    .ifNotExists()
    ...
    async #ensureMigrationLockTableExists() {
        if (!(await this.#doesTableExists(exports.MIGRATION_LOCK_TABLE))) {
            try {
                await this.#props.db.schema
                    .createTable(exports.MIGRATION_LOCK_TABLE)
                    .ifNotExists()
    ...
    async #ensureLockRowExists() {
        if (!(await this.#doesLockRowExists())) {
            try {
                await this.#props.db
                    .insertInto(exports.MIGRATION_LOCK_TABLE)
    ...
    async #doesLockRowExists() {
        const lockRow = await this.#props.db
            .selectFrom(exports.MIGRATION_LOCK_TABLE)
    ...
    async #runMigrations(getTargetMigrationIndex) {
        const run = async (db) => {
            try {
                await this.#props.db[private_symbols_js_1.PRIVATE_ADAPTER].acquireMigrationLock(db);
                ...
                await this.#props.db[private_symbols_js_1.PRIVATE_ADAPTER].releaseMigrationLock(db);
            }
        };
        if (this.#props.db[private_symbols_js_1.PRIVATE_ADAPTER].supportsTransactionalDdl) {
        ...
        for (let i = 0; i < results.length; ++i) {
            ...
            try {
                if (migration.down) {
                    ...
                    await db
                        .deleteFrom(exports.MIGRATION_TABLE)
    ...
    async #migrateUp(db, state, targetIndex) {
        ...
        for (let i = 0; i < results.length; ++i) {
            ...
            try {
                ...
                await db
                    .insertInto(exports.MIGRATION_TABLE)
                    .values({
                    name: migration.name,
